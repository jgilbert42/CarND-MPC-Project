      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          // calculate future state based on system latency estimate
          double latency = 0.12;
          ...
          double elapsed_ms = (stop.tv_sec - start.tv_sec) * 1e3 + (stop.tv_nsec - start.tv_nsec) / 1e6;
          cout << "processing elapsed: " << elapsed_ms << endl;
